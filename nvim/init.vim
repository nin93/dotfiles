...
set scrolloff=30          " Keeps cursor in the middle of screen when possible
...
" Reset cursor mode to terminal default
...
command! ConfigRofi       edit $HOME/.config/rofi/config.rasi
